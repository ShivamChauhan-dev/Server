...
app.use("/Admin", require("./routes/admin/Inventory"))
app.use("/Pilot", require("./routes/pilot/ProjectFieldfill"))
app.use("/Pilot", require("./routes/pilot/datafilling"))
app.use("/Pilot", require("./routes/pilot/Dpr"))
app.use("/Pilot", require("./routes/pilot/Attendence"))


app.listen(5000, () => {
  console.log(`Server is starting on port 1000`);
});
